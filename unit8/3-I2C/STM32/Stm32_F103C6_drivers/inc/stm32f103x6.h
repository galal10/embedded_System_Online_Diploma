...
#define RCC_USART2_CLK_DIS()		(RCC->APB1ENR &= ~(1<<17))
#define RCC_USART3_CLK_DIS()		(RCC->APB1ENR &= ~(1<<18))
//SPI
#define RCC_SPI1_CLK_DIS()			(RCC->APB2ENR &= ~(1<<12))
#define RCC_SPI2_CLK_DIS()			(RCC->APB1ENR &= ~(1<<14))
//I2C
#define RCC_I2C1_CLK_DIS()			(RCC->APB1ENR &= ~(1<<21))
#define RCC_I2C2_CLK_DIS()			(RCC->APB1ENR &= ~(1<<22))
...
//USART
#define RCC_USART1_CLK_DERESET()		(RCC->APB2RSTR &= ~(1<<14))
#define RCC_USART2_CLK_DERESET()		(RCC->APB1RSTR &= ~(1<<17))
#define RCC_USART3_CLK_DERESET()		(RCC->APB1RSTR &= ~(1<<18))
//SPI
#define RCC_SPI1_CLK_DERESET()			(RCC->APB2RSTR &= ~(1<<12))
#define RCC_SPI2_CLK_DERESET()			(RCC->APB1RSTR &= ~(1<<14))
//I2C
#define RCC_I2C1_CLK_DERESET()			(RCC->APB1RSTR &= ~(1<<21))
#define RCC_I2C2_CLK_DERESET()			(RCC->APB1RSTR &= ~(1<<22))
...
//I2C
#define NVIC_IRQ31_I2C1_EV_Enable()			(NVIC_ISER0 |= I2C1_EV_IRQ)
...
//I2C
#define NVIC_IRQ31_I2C1_EV_Disable()		(NVIC_ICER0 |= I2C1_EV_IRQ)

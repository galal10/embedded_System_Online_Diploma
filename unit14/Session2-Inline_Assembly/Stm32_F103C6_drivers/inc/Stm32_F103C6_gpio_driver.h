...
#define GPIO_ANALOG_MODE			0x00000000u //Analog mode
#define GPIO_INPUT_FLO_MODE			0x00000001u //Floating input
#define GPIO_INPUT_PU_MODE			0x00000002u //Input pull-up
#define GPIO_INPUT_PD_MODE			0x00000003u //Input pull-down
#define GPIO_OUTPUT_PP_MODE			0x00000004u //General purpose output push-pull
#define GPIO_OUTPUT_OD_MODE			0x00000005u //General purpose output Open-drain
#define GPIO_OUTPUT_AF_PP_MODE		0x00000006u //Alternate function output Push-pull
#define GPIO_OUTPUT_AF_OD_MODE		0x00000007u //Alternate function output Open-drain
#define GPIO_INPUT_AF_MODE			0x00000008u //Alternate function Input
